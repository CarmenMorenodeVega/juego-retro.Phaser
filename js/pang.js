    ...
    game.load.image('MoscowRussia', 'assets/MoscowRussia.png');
    game.load.image('BrooklynNewYork', 'assets/BrooklynNewYork.png');
    game.load.image('gameover', 'assets/gameover.jpg');
    game.load.audio('theme', ['audio/bandaSonora.mp3']);
    }
    ...
    function create(){
    	...
    	//Si se repite cuando finalice de reproducir
    	music.loop = true; 
    	//Reproducir
    	music.play();
        ...
        //Hacer que el juego se inicie
        ball.body.collideWorldBounds = true;

        //Introducimos la bola y definimos la posición según vector (x,y)
        ball.body.bounce.setTo(1, 1);
        ball.scale.setTo(scake, scake);
        //Introcucimos los jugadores
        player.body.collideWorldBounds = true;
        player2.body.collideWorldBounds = true
        ...
        scoreText2 = game.add.text(750, 20, 'Score P2: 0', { fontSize: '32px', fill: '#FFFFFF' });
        
        /*************************/
        /*  LIVES (VIDAS)        */
        /*************************/
        livesText = game.add.text(16, 550, 'Lives P1: ' + livesplayer1, { fontSize: '32px', fill: '#FFFFFF' });
        livesText2 = game.add.text(750, 550, 'Lives P2: ' + livesplayer2, { fontSize: '32px', fill: '#FFFFFF' });
        
    }

    /**********************************************/
    /*  DEFINIMOS LA FUNCION PARA DIVIDIR BOLAS   */
    /**********************************************/
    ...
    /***********************************************/
    /*  DEFINIMOS LAS FUNCIONES DE ACTUALIZACIONES */
    /***********************************************/

    function update(){ 
    //Establecemos las posibles alternativas de estados durante la partida.
        
        gameOver();//La partida finaliza cuando ambos jugadores pierden todas las vidas
    ...
    /***********************************************/
    /*  DENIFICION DE DISPAROS DE LOS JUGADORES    */
    /***********************************************/
    ...
    /***********************************************/
    /*  GENERAR PLATAFORMAS ALEATORIAMENTE         */
    /***********************************************/
    ...
    /******************************************************/
    /*  CARGAR LOS ELEMENTOS DEL JUEGO PARA VISUALIZARLOS */
    /******************************************************/
    ...
    /******************************************/
    /*  DEFINIR LA MUERTE DE LOS JUGADORES    */
    /******************************************/
    ...
    /****************************************************/
    /*  EL JUGADOR RETORNA DESPUÉS DE PERDER UNA VIDA   */
    /****************************************************/
    ...
    /**************************************/
    /*  GENERAR LOS FONDOS DEL JUEGO      */
    /**************************************/

    function generateBackground(){
        var background = Math.floor((Math.random() * 10) + 1);
        if (background < 5){
            sky = game.add.sprite(-180, 0, 'BrooklynNewYork');    
        } else { sky = game.add.sprite(-100, 0, 'MoscowRussia'); } 
        sky.scale.setTo(0.8, 0.8);
    }

    /**************************************/
    /*  GAME OVER Y VOLVER A JUGAR        */
    /**************************************/

    function showGameOverText(){
        var gameoverbackground = game.add.sprite(0, 0, 'gameover');
        var stateText = game.add.text(game.world.width/2-130, game.world.height/2-50, 
            'GAME OVER', { 
            fontSize: '40px', fill: '#420B3E' });
        var stateText2 = game.add.text(game.world.width/2-130, game.world.height/2, 
            'Volviendo a menú en 3, 2, 1...', {
            fontSize: '20px', fill: '#420B3E' });
    }
    ...
    /********************************************************/
    /*  GENERAR BOLAS Y GENERAR BONUS "ESTRELLA"A 5 BOLAS   */
    /********************************************************/
    ...
    /********************************************/
    /*  CONSEGUIR / USAR EL BONUS "ESTRELLA"    */
    /********************************************/
